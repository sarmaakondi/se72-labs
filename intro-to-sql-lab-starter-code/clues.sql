...
SELECT code, region, population FROM countries WHERE region = 'Southern Europe' ORDER BY population LIMIT 1;
...
SELECT countrycode, percentage FROM countrylanguages WHERE language = 'Italian' AND isofficial = TRUE ORDER BY percentage DESC LIMIT 1;
